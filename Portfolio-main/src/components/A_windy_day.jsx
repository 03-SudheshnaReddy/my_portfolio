...
export default function Model({props,isMobile}) {
  const group = useRef()
  const { nodes, materials} = useGLTF('/a_windy_day.glb')
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]} scale={isMobile ? [18,18,18]:[20,20,20]}>
...
useGLTF.preload('/a_windy_day.glb')
